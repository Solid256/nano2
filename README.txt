...
cd ../nano-3.2
mkdir stage
./configure --prefix /home/<username>/Downloads/nano-3.2/stage
make
sudo make install

This will build the program inside of the stage folder in your nano source code folder.

Go to the folder nano-3.2/stage/bin and type ./nano to run the program. Do NOT type 'nano' by itself, as this will run the original nano.
